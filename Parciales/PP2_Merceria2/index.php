...
$app->post("/usuarios", \Usuario::class . ":AgregarUsuario")->add(\MW::class . ":VerificarBD")->add(\MW::class . ":VerificarCorreoClave")->add(\MW::class . ":VerificarCorreoClaveEmpty");

$app->get("/", \Usuario::class . ":MostrarUsuarios");

$app->post("/ventas", \Ventas::class . ":AgregarVenta");

$app->get("/ventas", \Ventas::class . ":MostrarVentas");

$app->delete("[/]", \Media::class. ":BorrarMedia")->add(\MW::class . "::VerificarPerfilPropietario")->add(\MW::class . "::VerificarPerfilEncargado");

$app->put("[/]", \Media::class. ":ModificarMedia")->add(\MW::class . "::VerificarPerfilPropietario")->add(\MW::class . "::VerificarPerfilEncargado");

$app->delete("/ventas", \Ventas::class. ":BorrarVenta")->add(\MW::class . ":VerificarPerfilEmpleado");

$app->put("/ventas", \Ventas::class. ":ModificarVenta")->add(\MW::class . ":VerificarPerfilEmpleado");

$app->get("/ListadoFotos", \Usuario::class . ":ListadoUsuarios");
